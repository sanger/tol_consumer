...
from tol_lab_share.constants import RABBITMQ_SUBJECT_CREATE_LABWARE
...
def test_create_labware_processor(config):
    with patch("tol_lab_share.processors.create_labware_processor.AvroEncoder") as mock_avro_encoder:
        ...
        mock_avro_encoder.assert_called_once_with(schema_registry, RABBITMQ_SUBJECT_CREATE_LABWARE)

...
INPUT_CREATE_LABWARE_MESSAGE_SAMPLE_ACCESSION_NUMBER = "accessionNumber"
INPUT_CREATE_LABWARE_MESSAGE_SAMPLE_GENOME_SIZE = "genomeSize"
INPUT_CREATE_LABWARE_MESSAGE_SAMPLE_COST_CODE = "costCode"
